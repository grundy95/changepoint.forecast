...
test_that("show and summary methods are working",{
  expect_type(invisible(capture.output(show(cptForecast(rnorm(500), m=300)))),'character')
  expect_type(invisible(capture.output(summary(cptForecast(rnorm(500), m=300)))),'character')
})
