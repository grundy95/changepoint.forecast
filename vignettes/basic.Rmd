...
This vignette runs through the basic functionality of the package with some simple examples. Only the main arguments are discussed here with the aim of getting users started with the package. For more details on the methodology; setting problem specific thresholds; and a framework for implementing this methodology in an online manor see the advanced vignette [changepoint.forecast: Methodology and Advanced Functionality](advanced.html).  
